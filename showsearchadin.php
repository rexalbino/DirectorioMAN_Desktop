      ...
      <div class="col s12">
		...
		?>
          <tr >
            ...
            <td><?php  echo "<a href=actualizar.php?id={$row2['id_Usuario']}><i class='material-icons'>mode_edit</i></a>";?></td>
            <td><?php  echo "<a href=beforedelete.php?id={$row2['id_Usuario']}><i class='material-icons'>delete</i></a>";?></td>
          </tr>
          <?php
				endwhile;
            ?>
